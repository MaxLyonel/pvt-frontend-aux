...
export default {
  ...
  methods: {
    ...
    async getMonths() {
      ...
      try {
        let res = await this.$axios.post("/contribution/list_months_import_contribution_senasir",{//api
    ...
    async ImportContributions() {
      ...
      try {
        let res = await this.$axios.post("/contribution/import_create_or_update_contribution_period_senasir",{//api
    ...
    async reportImportContributionSenasir(month_selected){
      ...
      try {
        let res = await this.$axios.post("/contribution/report_import_contribution_senasir",{//api
