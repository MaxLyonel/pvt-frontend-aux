...
export default {
  ...
  methods: {
    ...
    async getYears() {
      try {
        this.loading = true;
        let res = await this.$axios.get("/contribution/list_senasir_years");//api
    ...
    async getMonths() {
      ...
      try {
        ...
        let res = await this.$axios.post("/contribution/list_months_validate_senasir",{//api
    ...
    async uploadFile() {
      ...
      try {
        let res = await this.$axios.post("/contribution/upload_copy_payroll_senasir",//api
          formData
        );
    ...
    async validateData() {
      ...
      try {
        let res = await this.$axios.post("/contribution/validation_payroll_senasir",{//api
    ...
    async downloadFailValidate() {
      try {
        ...
        let res = await this.$axios.post("/contribution/download_fail_not_found_payroll_senasir",{//api
            date_payroll: this.dateFormat,
          },
    ...
    async ImportContributions() {
      ...
      try {
        let res = await this.$axios.post("/contribution/import_create_or_update_contribution_payroll_period_senasir",{//api
    ...
    async rollbackContribution() {
      ...
      try {
        let res = await this.$axios.post("/contribution/rollback_payroll_copy_senasir",{//api
            date_payroll: this.dateFormat,
          }
        );
    ...
    async importProgressBar() {
      try {
        let res = await this.$axios.post("/contribution/import_payroll_senasir_progress_bar",{//api
            date_payroll: this.dateFormat,
          }
        );
    ...
    async reportPayrollSenasir(month_selected){
      ...
      try {
        let res = await this.$axios.post("/contribution/report_payroll_senasir",{//api
            date_payroll: this.dateFormat
          },
          {'Accept': 'application/vnd.ms-excel' },
          {'responseType': 'blob'}
